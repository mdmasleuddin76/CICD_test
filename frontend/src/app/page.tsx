...
export default function Home() {
  ...
  return (
    <div className=" w-[70%] m-auto text-center">
      <h1>Home</h1>
      <p>Welcome to Home Page trying finally changed at 12pm </p>
      <p> Some data that has been feteched from backend are following abcfdgdfgfhjfhj</p>
      ...
      <p>i have added some content here at new content added at 5:00 abcdff </p>
    </div>
  );
}
